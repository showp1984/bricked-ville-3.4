...
static struct msm_gpiomux_config ville_slimbus_configs[] __initdata = {
	{
		.gpio	= VILLE_GPIO_AUD_WCD_SB_CLK,		
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
	{
		.gpio	= VILLE_GPIO_AUD_WCD_SB_DATA,		
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
